...
QUALITY_FLAGS = {
    ...
    "CURT_EXPORT_LIMIT":1<<14,  # clipping at point-of-interconnection export limit (recoverable revenue)
    "STRING_UNDERPERFORM":1<<15, # lone low string — non-disqualifying; feeds fault classifier
}
...
# STRING_UNDERPERFORM is intentionally excluded from DISQUALIFYING so
# the fault classifier sees those rows instead of having them silently dropped.
